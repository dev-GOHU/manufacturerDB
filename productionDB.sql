...
CREATE TABLE `원자재보관량` (
	`id`	INT(11)	NOT NULL,
	`제조공장_id` INT(3) NOT NULL,
	`예상소비량` INT NOT NULL,
	`보관량`	INT NOT NULL,
	FOREIGN KEY (`id`) REFERENCES `원자재`(`id`) ON UPDATE CASCADE ON DELETE CASECADE,
	FOREIGN KEY (`제조공장_id`) REFERENCES `제조공장`(`id`) ON UPDATE CASCADE ON DELETE CASECADE
);
...
CREATE TABLE `구매로그` (
	...
	`제조공장_id`	INT(3)	NOT NULL,
	`금액`	INT	NOT NULL,
	`구매일자`	TIMESTAMP	NOT NOT NULL,
	FOREIGN KEY(`제조공장_id`) REFERENCES `제조공장`(`id`) ON UPDATE CASCADE ON DELETE CASCADE
);

CREATE TABLE `원자재구매` (
	`id`	INT(20)	PRIMARY KEY,
	`원자재거래처_id`	INT(3)	NOT NULL,
	`원자재_id`	INT(11)	NOT NULL,
	`제조공장_id` INT(3) NOT NULL,
	`구매량`	INT	NOT NULL,
	`유통기한`	DATE	NOT NULL,
...
CREATE TABLE `주문` (
	...
	`택배업체거래처_id`	INT(3)	NOT NULL,
	`제조공장_id`	INT(3)	NULL	DEFAULT NULL,
	`결제금액`	INT	NOT NULL,
	`주소`	VARCHAR(255)	NOT NULL,
